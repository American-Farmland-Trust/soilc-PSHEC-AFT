...
# ML predictions
group_23_ML <- read.csv('data/soil/Coefficients/corn/group_23_ML_model_OM_range_yield_predictions_intervals.csv', row.names = 'X')

I_ML <- read.csv('data/soil/Coefficients/corn/IA_IL_IN_OH_ML_model_OM_range_yield_predictions_intervals.csv', row.names = 'X')
...
write.csv(ML_results, file = 'data/soil/Comet_data/corn_all_yield_predictions_intervals_machine_learning_model.csv')
...
# ML predictions
group_soy_ML <- read.csv('data/soil/Coefficients/soy/group_23_ML_model_OM_range_yield_predictions_intervals.csv', row.names = 'X')

I_soy_ML <- read.csv('data/soil/Coefficients/soy/IA_IL_IN_OH_ML_model_OM_range_yield_predictions_intervals.csv', row.names = 'X')
...
write.csv(ML_soy_results, file = 'data/soil/Comet_data/soy_all_yield_predictions_intervals_machine_learning_model.csv')
...
# ML predictions
all_wheat_ML <- read.csv('data/soil/Coefficients/wheat/all_ML_model_OM_range_yield_predictions_intervals.csv', row.names = 'X')
...
write.csv(ML_wheat_results, file = 'data/soil/Comet_data/wheat_all_yield_predictions_intervals_machine_learning_model.csv')
