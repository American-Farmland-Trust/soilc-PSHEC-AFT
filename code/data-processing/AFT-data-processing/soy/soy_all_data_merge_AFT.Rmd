...
```{r data}
# Yield data
yield <- read_rds('data/AFT-data/soy_yield_2000-2022_w_irrigation_n_15.rds')

#gssurgo soil data
soil <- read_rds('data/AFT-data/soy_gssurgo.soil.stats_n_15_filter_om10.rds')
...
```{r check}
all_data <- read_rds('data/AFT-data/soy_all_data_n15_om10_AFT.rds')
